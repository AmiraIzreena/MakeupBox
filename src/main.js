...
btnCreate.addEventListener('click', function(){  //creating text file when user click CREATE button
  ...
  fs.writeFile(file, contents, function(err){ // textfile yg kita nak write: apa yg kita nak write ke text file
    if(err){
...
btnDelete.addEventListener('click', function(){   //delete content when user click on DELETE button
  let file = path.join(pathName, fileName.value)
